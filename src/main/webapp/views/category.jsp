                    ...
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="<%=request.getContextPath()%>/catalogController/initCreate">
                                    <button type="button" class="btn btn-success">+ Add new Category
                                    </button>
                                </a>
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listCatalog}" var="cat">
                                <tr>
                                    ...
                                    <td><fmt:formatDate value="${cat.createDate}" pattern="dd/MM/yyyy"/></td>
                                    <td>${cat.catalogStatus?"Active":"Inactive"}</td>
                                    <td>
                                        <input type="hidden" id="catDeleteId" value="${cat.catalogID}">
                                        <a class="navbar-brand" href="<%=request.getContextPath()%>/catalogController/initUpdate?catalogID=${cat.catalogID}">
